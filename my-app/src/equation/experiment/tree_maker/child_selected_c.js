//child selected with comments
//#export let child_selected_tree = {
     //#child_selected:{
function child_selected(event)
{
	...
	if( selectable_child_count == selected_child_count )
	{
        ...
        //#out_loop_subformula:{
        //#if_parent_type_bracket:{
        
        if( tree.props.type == 'bracket')
        {   
            //#add_brackets_to_subformula: {
        ...
        if( !isRoot )
        {
            //#tree_set_selected_true: {
            tree.props.selected = true
            tree.updateProps() 
            //#},
            
            //#dispatch_select_upward:{
            dispatch('select', {
                child_tree:tree,
        ...
        {    
            ...
            //#if_event_tree_type_is_box:{
            if( e_tree.props.type == 'box')
            {
                 //#event_tree_show_arrow:{
    ...
    //#},
    //#else_if_not_all_child_selected:{}
	else
	{
